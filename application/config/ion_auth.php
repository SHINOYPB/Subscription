...
$config['tables']['users_groups']    = 'admins_groups';
 ...
 */
$config['site_title']                 = "United Christian World";       // Site Title, example.com
$config['admin_email']                = "info@merakesh.online"; // Admin Email, admin@example.com
