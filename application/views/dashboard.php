            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  <tbody>
                    <tr>
                      <td class="ms-table-f-w"> <img src="../../assets/admin/assets/img/dashboard/product-1.jpg" alt="people"> <a href="#">White Widow </a></td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="../../assets/admin/assets/img/dashboard/product-2.jpg" alt="people"> <a href="#">Super Sunk </a></td>
                      <td><span class="badge badge-success">In Stock</span></td>
                      <td>27-10-2020</td>
                      <td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="../../assets/admin/assets/img/dashboard/product-3.jpg" alt="people"><a href="#">Low Rider</a></td>
              ...
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="../../assets/admin/assets/img/dashboard/product-2.jpg" alt="people"><a href="#">Super Skunk</a></td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="../../assets/admin/assets/img/dashboard/product-2.jpg" alt="people"> <a href="#">Low Rider</a> </td>
