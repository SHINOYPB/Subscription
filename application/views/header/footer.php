            ...
            <div class="ms-chat-header px-3">
              <div class="ms-chat-user-container media clearfix">
                <div class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                  <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-1.jpg')?>" class="ms-img-round" alt="people">
                </div>
              ...
              <div class="tab-content">
                  ...
                  <ul class="ms-scrollable ms-quickbar-container">
                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                      <div class="ms-chat-status ms-status-away ms-has-new-msg ms-chat-img mr-3 align-self-center">
                        ...
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-2.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
                    ...
                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                      <div class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-3.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
                    ...
                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                      <div class="ms-chat-status ms-status-offline ms-chat-img mr-3 align-self-center">
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-4.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
                    ...
                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                      <div class="ms-chat-status ms-status-busy ms-chat-img mr-3 align-self-center">
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-5.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
                  ...
                  <ul class="ms-scrollable ms-quickbar-container">
                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                      ...
                      <div class="media-body ms-chat-user-info mt-1">
                        ...
                        <ul class="ms-group-members clearfix mt-3 mb-0">
                          <li> <img src="<?php echo base_url('assets/img/dashboard/rakhan-potik-1.jpg')?>" alt="member"> </li>
                          <li> <img src="<?php echo base_url('assets/img/dashboard/rakhan-potik-2.jpg')?>" alt="member"> </li>
                          <li> <img src="<?php echo base_url('assets/img/dashboard/rakhan-potik-3.jpg')?>" alt="member"> </li>
                    ...
                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                      ...
                      <div class="media-body ms-chat-user-info mt-1">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                        <ul class="ms-group-members clearfix mt-3 mb-0">
                          <li> <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-3.jpg')?>" alt="member"> </li>
                          <li> <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-4.jpg')?>" alt="member"> </li>
                        </ul>
                      </div>
                    </li>
                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                      ...
                      <div class="media-body ms-chat-user-info mt-1">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                        <ul class="ms-group-members clearfix mt-3 mb-0">
                          <li> <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-2.jpg')?>" alt="member"> </li>
                          <li> <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-3.jpg')?>" alt="member"> </li>
                          <li> <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-4.jpg')?>" alt="member"> </li>
                ...
                <div role="tabpanel" class="tab-pane fade" id="contacts">
                  <ul class="ms-scrollable ms-quickbar-container">
                    ...
                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                      <div class="ms-chat-img mr-3 align-self-center">
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-7.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
                        <h6>Raymart Sandiago</h6> <a href="#" class="ms-chat-time"> <i class="flaticon-chat"></i> </a>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                    ...
                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                      <div class="ms-chat-img mr-3 align-self-center">
                        <img src="<?php echo base_url('assets/admin/assets/img/dashboard/rakhan-potik-8.jpg')?>" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body ms-chat-user-info mt-1">
            ...
            <ul class="ms-scrollable ms-quickbar-container">
              <li class="p-3  media ms-email clearfix">
                <div class="ms-email-img mr-3 ">
                  <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-1.jpg" class="ms-img-round" alt="people">
                </div>
              ...
              <li class="p-3  media ms-email clearfix">
                <div class="ms-email-img mr-3 ">
                  <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-2.jpg" class="ms-img-round" alt="people">
                </div>
                <div class="media-body ms-email-details">
              ...
              <li class="p-3  media ms-email clearfix">
                <div class="ms-email-img mr-3 ">
                  <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-3.jpg" class="ms-img-round" alt="people">
                </div>
                <div class="media-body ms-email-details">
                    ...
                    <li class="ms-scrollable ms-dropdown-list ms-members-list">
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-4.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                          <span>John Doe</span>
                        </div>
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-5.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-7.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                ...
                <div class="dropdown float-left">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="ms-scrollable ms-dropdown-list ms-members-list">
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="../../../assets/admin/assets/img/dashboard/rakhan-potik-8.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                          <span>Heather Brown</span>
                        </div>
  ...
  <script src="<?php echo base_url('assets/admin/assets/js/moment.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/jquery.webticker.min.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/Chart.bundle.min.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/Chart.Financial.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/table-line.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/index-chart.js')?>"> </script>

  <script src="<?php echo base_url('assets/admin/assets/js/d3.v3.min.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/topojson.v1.min.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/datamaps.all.min.js')?>"> </script>
  <script src="<?php echo base_url('assets/admin/assets/js/index-map.js')?>"> </script>

  <!-- Page Specific Scripts End -->

  <!-- Weedo core JavaScript -->
  <script src="<?php echo base_url('assets/admin/assets/js/framework.js')?>"></script>
...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/weedoboard/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 12:15:42 GMT -->
</html>
