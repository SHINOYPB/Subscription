...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index-2.html"> <img src="assets/img/dashboard/greendash-logo.png" alt="logo"> </a>
    </div>
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          ...
          <li> <a href="dashboard/project-management.html">Project Management</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="order-page" class="collapse" aria-labelledby="order-page" data-parent="#side-nav-accordion">
          <li> <a href="order/order-status.html">Order Status</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="product-page" class="collapse" aria-labelledby="product-page" data-parent="#side-nav-accordion">
          <li> <a href="product/product-list.html">Products-list</a> </li>
          <li> <a href="product/product-grid.html">Products-Grid</a> </li>
          <li> <a href="product/product-detail.html">Products-Details</a> </li>
          <li> <a href="product/cancel-product.html"> Cancel Products</a> </li>
          <li> <a href="product/return-product.html">Return Products</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
          <li> <a href="customer/customer.html">Customers-list</a> </li>
          <li> <a href="customer/reviews.html">Reviwes</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="invoice" class="collapse" aria-labelledby="invoice" data-parent="#side-nav-accordion">
          ...
          <li> <a href="invoice/invoice-list.html">Invoice-List</a> </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="../../index-2.html"><img src="../../assets/img/dashboard/greendash-logo-84x41.png" alt="logo"> </a>
      </div>
        ...
        <div class="col-xl-6 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
              ...
              <p class="mb-0 mt-3">Don't have an account? <a class="btn-link" href="#">Create an Account</a> </p>
            </div>
          </div>
        </div>
        <div class="col-xl-6 col-md-12">
              ...
              <form class="needs-validation clearfix" novalidate>
                <div class="form-row">
                  <div class="col-xl-6 col-md-12 mb-3">
                    <label for="validationCustom10">Full Name</label>
                    <div class="input-group">
                  ...
                  <div class="col-xl-6 col-md-12">
                    <label for="validationCustom11">Email Address</label>
                    <div class="input-group">
                      <input type="email" class="form-control" id="validationCustom11" placeholder="Email Address" required>
                      <div class="invalid-feedback">
                        Please provide a valid email.
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <label for="validationCustom12">Message</label>
                    <div class="input-group">
          ...
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
              <form class="needs-validation clearfix" novalidate>
                <div class="form-row">
                  <div class="col-md-12">
                    <label for="validationCustom08">Payment Method</label>
                ...
                <div class="form-row">
                  <div class="col-xl-6 col-md-12 mb-3">
                    <label for="validationCustom13">Card Holder Name</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom13" placeholder="Card Holder Name" required>
                      <div class="invalid-feedback">
                        Please provide full name
                      </div>
                    </div>
                  ...
                  <div class="col-xl-6 col-md-12">
                    <label for="validationCustom14">Card Number</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom14" placeholder="Card Number" required>
                      <div class="invalid-feedback">
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom15">Month</label>
                    <div class="input-group">
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom16">Year</label>
                    <div class="input-group">
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">CVV <i class="material-icons">info_outline</i> </label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom17" placeholder="CVV" required>
                      <div class="invalid-feedback">
                ...
                <button class="btn btn-primary float-right" type="submit">Save and Continue</button>
              </form>
            </div>
          </div>
        </div>
              ...
              <div class="ms-panel ms-panel-fh">
                ...
                <div class="ms-panel-body">
                  <form class="needs-validation clearfix" novalidate>
                    <div class="form-row">
                      <div class="col-xl-6 col-md-12 mb-3">
                        <label for="validationCustom27">Full Name</label>
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationCustom27" placeholder="Full Name" required>
                          <div class="invalid-feedback">
                            Please provide full name
                          </div>
                        </div>
                      ...
                      <div class="col-xl-6 col-md-12">
                        <label for="validationCustom28">Email Address</label>
                        <div class="input-group">
                          <input type="email" class="form-control" id="validationCustom28" placeholder="Email Address" required>
                          <div class="invalid-feedback">
                    ...
                    <button class="btn btn-primary w-100 d-block" type="submit">Subscribe Now</button>
                  </form>
                </div>
              </div>
            </div>
              ...
              <div class="ms-panel ms-panel-fh">
                ...
                <div class="ms-panel-body">
                  <form class="needs-validation clearfix" novalidate>
                    <div class="form-row">
                      <div class="col-xl-6 col-md-12 mb-3">
                        <label for="validationCustom29">Username</label>
                        <div class="input-group">
                          <input type="text" class="form-control" id="validationCustom29" placeholder="Username" required>
                          <div class="invalid-feedback">
                      ...
                      <div class="col-xl-6 col-md-12">
                        <label for="validationCustom30">Email Address</label>
                        <div class="input-group">
                          <input type="email" class="form-control" id="validationCustom30" placeholder="Email Address" required>
                          <div class="invalid-feedback">
                            Please provide an email.
                          </div>
                        </div>
                    ...
                    <button class="btn btn-primary w-100 d-block" type="submit">Send Request</button>
                  </form>
                </div>
              </div>
            </div>
...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/weedoboard/pages/form/form-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 12:22:34 GMT -->
</html>
